			...
			It("should populate resource map with multiple devices when request has count > 1", func() {
				...
				resourceSlice := &resourcev1api.ResourceSlice{
					...
					Spec: resourcev1api.ResourceSliceSpec{
						...
						Devices: []resourcev1api.Device{
							{Name: device1Name, Attributes: map[resourcev1api.QualifiedName]resourcev1api.DeviceAttribute{multusDeviceIDAttr: {StringValue: &deviceID1}}},
							{Name: device2Name, Attributes: map[resourcev1api.QualifiedName]resourcev1api.DeviceAttribute{multusDeviceIDAttr: {StringValue: &deviceID2}}},
							{Name: device3Name, Attributes: map[resourcev1api.QualifiedName]resourcev1api.DeviceAttribute{multusDeviceIDAttr: {StringValue: &deviceID3}}},
						},
					},
				}
